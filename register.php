...
<head>
    ...
    <title>Register - MK Viewer</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        <div class="auth-box">
            ...
            <div class="error-msg">
                ...
                switch($_GET['error']) {
                    ...
                    case 'phone': echo "Invalid phone number!"; break;
                    case 'password': echo "Passwords don't match!"; break;
                    case 'exists': echo "Email already registered!"; break;
